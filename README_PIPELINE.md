...
### Notebooks
- ✅ `notebook_bronze.ipynb` - Ingestão de dados brutos (Bronze)
- ✅ `notebook_prata.ipynb` - Transformação e relacionamento (Prata)
- ✅ `notebook_ouro.ipynb` - Enriquecimento e dados finais (Ouro)
